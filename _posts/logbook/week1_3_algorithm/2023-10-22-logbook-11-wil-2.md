...
## 1주차 회고
1주차부터 3주차까지는 algorithm.png을 진행한다. 이번 주에 나는 algorithm.png 공부를 했는데, 이렇게 하루종일 algorithm.png만 한 것은 처음이다. 그런데도 문제를 얼마 못푸니 문제다. algorithm.png 시간을 정해놓고 다른 것들도 해야하는데 하루종일 붙잡고 있으니 시간 분배가 잘 안된다. 다른 사람들은 어떻게 항해99를 진행했는지 찾아보던 중 나와 같은 고민을 한 선배기수가 있었다. 선배 기수의 algorithm.png 공부법을 조금 변형하여 나에게도 한번 적용시켜 공부해 봐야겠다.
...
어떻게 접근했는지, 어떤 algorithm.png을 사용하는지 파악하며, 코드를 따라쳐본다. 무작정 따라치지말고, 흐름을 이해한다.
...
## algorithm.png 문제 1주차
<details>
<summary> algorithm.png 1주차 </summary>

<div markdown="1">

    - 1회차 : **algorithm.png 개요**
            - 그룹 애너그램
            - 가장 긴 팰린드롬 부분 문자열
            - 세 수의 합
            - 배열 파티션
